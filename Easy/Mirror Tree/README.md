<h2><a href="https://practice.geeksforgeeks.org/problems/mirror-tree/1?page=1&status[]=unsolved&sortBy=submissions">Mirror Tree</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a Binary Tree, convert it into its mirror.<br>

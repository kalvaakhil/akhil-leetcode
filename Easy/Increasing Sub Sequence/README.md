<h2><a href="https://practice.geeksforgeeks.org/problems/increasing-sub-sequence1712/1">Increasing Sub Sequence</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string S which includes characters a, b, c, ..., z. Where value of a=1, b=2, ..., z=26. Now find the length of the&nbsp;largest increasing subsequence in the string.</span></p>

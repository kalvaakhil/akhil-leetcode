<h2><a href="https://practice.geeksforgeeks.org/problems/inorder-traversal-and-bst5855/1">Inorder Traversal and BST</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array <strong>arr</strong>&nbsp;of size <strong>N</strong>, write a program that returns <strong>1</strong> if array represents Inorder traversal of a BST, else returns <strong>0</strong>.<br>

<h2><a href="https://practice.geeksforgeeks.org/problems/maximum-sum-rectangle2948/1?utm_source=youtube&utm_medium=collab_anujbhaiya_description&utm_campaign=maximum-sum-rectangle">Maximum sum Rectangle</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:20px">Given a 2D matrix M of dimensions RxC. Find the maximum sum submatrix in it.</span></p>
